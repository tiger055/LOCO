...
BOT_OWNER_ROLE = 'royal' # change to what you need
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('Nzc4OTQ2NjA2MTI0NDk4OTg0.X7ZYjw.HrQ2FosidFvbDRZhGsdb6JABUH4Nzc4OTQ2NjA2MTI0NDk4OTg0.X7ZYjw.HrQ2FosidFvbDRZhGsdb6JABUH4'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NTc5OTA3NDUxMzE5NjE1NDk5.X7aGjg.PFPTJBNYJqJPqMOQM9aSCGmVECk',
                                   bot=False))
    loop.run_forever()
